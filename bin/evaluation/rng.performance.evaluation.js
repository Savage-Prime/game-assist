...
describe("RNG Performance & Stress Tests", () => {
    ...
    describe("Concurrent Usage Simulation", () => {
        it("should maintain randomness quality under concurrent-like usage", async () => {
            ...
            const batchMeanVariance = batchMeans.reduce((sum, mean) => sum + Math.pow(mean - overallMean, 2), 0) / (batchMeans.length - 1);
...
//# sourceMappingURL=rng.performance.evaluation.js.map